...
{
    /// <summary>
    /// Build and parse state:  0.Nomi_Size:;Width:25;Height:50 - 1.Frame:CH - 11.Shape:STD;H1:;W1: - 17.FMCtrlDmp:None
    /// </summary>
    public class UnitSelectionAndPricingEngineStateParser : IUnitSelectionAndPricingEngineStateParser
    {
        ...
        public UnitSelectionAndPricingEngineStateParser(string uiOptionsSeparator = " - "
        ...
        public (string UiOptionsSelectedValuesAsString, string UiOptionsSelectedValuesWithStepIdAsString) GetConcatenatedUiOptionsSelectedValuesAsString(UnitSelectionAndPricingEngine pricingEngine)
        {
        ...
        public List<IApiResultMessageModel> RebuildOptionsState(UnitSelectionAndPricingEngine pricingEngine, string optionsStateString)
        {
        ...
        public List<IApiResultMessageModel> RebuildParentOptionState(UnitSelectionAndPricingEngine pricingEngine, string parentOptionAndDependentControlsString)
        {
    ...
    public interface IUnitSelectionAndPricingEngineStateParser
    {
        (string UiOptionsSelectedValuesAsString, string UiOptionsSelectedValuesWithStepIdAsString)
            GetConcatenatedUiOptionsSelectedValuesAsString(UnitSelectionAndPricingEngine pricingEngine);

        //List<IApiResultMessageModel> RebuildOptionsState(UnitSelectionAndPricingEngine pricingEngine, string optionsStateString);

        //List<IApiResultMessageModel> RebuildParentOptionState(UnitSelectionAndPricingEngine pricingEngine, string parentOptionAndDependentControlsString);
